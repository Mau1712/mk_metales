...
export const MaterialsHeroElement = styled.section`
  position: relative;
  width: 100%;
  overflow: hidden;
  ...
  background-image: linear-gradient(
    ...
    color-mix(
        in srgb,
        ${({ theme }) => theme.color.background.secondary} 62%,
...
export const MaterialsHeroInnerElement = styled(SectionContainer)`
  position: relative;
...
export const MaterialsHeroCopyElement = styled.div`
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
export const MaterialsHeroEyebrowElement = styled.p`
  margin: 0;
...
export const MaterialsHeroTitleElement = styled.h1`
...
export const MaterialsHeroDescriptionElement = styled.p`
  max-width: 58ch;
  margin: ${({ theme }) => `${theme.spacing(2)} 0 0`};
  color: color-mix(
    in srgb,
...
export const MaterialsHeroSignalsElement = styled.ul`
  display: flex;
  flex-wrap: wrap;
  align-items: center;
...
export const MaterialsHeroSignalItemElement = styled.li`
...
export const MaterialsHeroActionsElement = styled.div`
  display: flex;
  flex-wrap: wrap;
...
export const MaterialsHeroPrimaryCtaElement = styled(Link)`
  ${heroCtaBase}
...
export const MaterialsHeroSecondaryCtaElement = styled(Link)`
  ${heroCtaBase}
  border: 1px solid

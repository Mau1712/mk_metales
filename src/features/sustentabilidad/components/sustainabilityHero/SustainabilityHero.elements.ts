...
export const SustainabilityHeroElement = styled.section`
  position: relative;
  width: 100%;
  overflow: hidden;
  ...
  &::after {
    ...
    background: radial-gradient(
      ...
      color-mix(
        in srgb,
        ${({ theme }) => theme.color.brand.primary} 18%,
        transparent
      )
        0%,
      transparent 70%
...
export const SustainabilityHeroInnerElement = styled(SectionContainer)`
  position: relative;
...
export const SustainabilityHeroCopyElement = styled.div`
  display: flex;
  flex-direction: column;
  align-items: flex-start;
  width: 100%;
...
export const SustainabilityHeroEyebrowElement = styled.p`
  margin: 0;
...
export const SustainabilityHeroTitleElement = styled.h1`
  display: flex;
  flex-direction: column;
...
export const SustainabilityHeroTitleLineElement = styled.span`
  color: ${({ theme }) => theme.color.text.light};
`;

export const SustainabilityHeroTitleAccentElement = styled.span`
  color: ${({ theme }) => theme.color.brand.primary};
`;

export const SustainabilityHeroDescriptionElement = styled.p`
  max-width: 58ch;
  margin: ${({ theme }) => `${theme.spacing(2)} 0 0`};
  color: color-mix(
    in srgb,
...
export const SustainabilityHeroSignalsElement = styled.ul`
  display: flex;
  flex-wrap: wrap;
  align-items: center;
...
export const SustainabilityHeroSignalItemElement = styled.li`
...
export const SustainabilityHeroActionsElement = styled.div`
  display: flex;
  flex-wrap: wrap;
...
export const SustainabilityHeroPrimaryCtaElement = styled(Link)`
  ${heroCtaBase}
...
export const SustainabilityHeroSecondaryCtaElement = styled(Link)`
  ${heroCtaBase}
  border: 1px solid

...
export const SustainabilityStagesElement = styled.section`
  width: 100%;
...
export const SustainabilityStagesInnerElement = styled(SectionContainer)`
  display: flex;
...
export const SustainabilityStagesTitleElement = styled.h2`
...
export const SustainabilityStagesListElement = styled.ol`
  display: flex;
  flex-direction: column;
...
export const SustainabilityStageElement = styled.li`
  display: grid;
...
export const SustainabilityStageNumberElement = styled.span`
...
export const SustainabilityStageCopyElement = styled.div`
  min-width: 0;
...
export const SustainabilityStageTitleElement = styled.h3`
  margin: 0;
  color: ${({ theme }) => theme.color.text.primary};
...
export const SustainabilityStageDescriptionElement = styled.p`

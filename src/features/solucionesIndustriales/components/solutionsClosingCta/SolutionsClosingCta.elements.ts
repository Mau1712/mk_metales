...
export const SolutionsClosingCtaElement = styled.section`
  position: relative;
  width: 100%;
  overflow: hidden;
...
export const SolutionsClosingInnerElement = styled(SectionContainer)`
  position: relative;
...
export const SolutionsClosingCopyElement = styled.div`
  display: flex;
...
export const SolutionsClosingEyebrowElement = styled.p`
  margin: 0;
...
export const SolutionsClosingTitleElement = styled.h2`
...
export const SolutionsClosingDescriptionElement = styled.p`
  max-width: 46ch;
  margin: ${({ theme }) => `${theme.spacing(2)} 0 0`};
  color: color-mix(
    in srgb,
...
export const SolutionsClosingActionsElement = styled.div`
  display: flex;
  flex-wrap: wrap;
...
export const SolutionsClosingPrimaryCtaElement = styled(Link)`
  ${closingCtaBase}
...
export const SolutionsClosingSecondaryCtaElement = styled(Link)`
  ${closingCtaBase}
  border: 1px solid

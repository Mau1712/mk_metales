...
export const SolutionsMaterialsNoteElement = styled.section`
  width: 100%;
...
export const SolutionsMaterialsNoteInnerElement = styled(SectionContainer)`
  display: flex;
...
export const SolutionsMaterialsTitleElement = styled.h2`
...
export const SolutionsMaterialsDescriptionElement = styled.p`
...
export const SolutionsMaterialsChipsElement = styled.ul`
  display: flex;
  flex-wrap: wrap;
...
export const SolutionsMaterialsChipElement = styled.li<{ $muted?: boolean }>`
  display: inline-flex;
  align-items: center;
...
export const SolutionsMaterialsCtaElement = styled(Link)`
  display: inline-flex;
  align-items: center;
